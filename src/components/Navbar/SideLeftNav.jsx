...
const SideLeftNav = () => {
  ...
  return (
    <div>
      <div className="md:col-span-3    border-slate-400 ">
        <button
          ...
          type="button"
          className="inline-flex items-center p-2  m-3  ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <span className="flex items-center p-2 text-gray-500 font-medium rounded-lg dark:text-white    group">
              Browse
            </span>
            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  <svg
                    class="w-6 h-6 text-cyan-400 dark:text-cyan-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="ms-3">Tracks</span>
                </NavLink>
              </li>
              <li>
                <NavLink
                ...
                >
                  <svg
                    class="w-6 h-6 text-yellow-400 dark:text-yellow-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="ms-3">New Release</span>
                </NavLink>
              </li>
              ...
              <li>
                ...
                >
                  <svg
                    class="w-6 h-6 text-blue-400 dark:text-blue-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="ms-3">Top Playlist</span>
                </NavLink>
              </li>
              <li>
                <NavLink
                ...
                >
                  <svg
                    class="w-6 h-6 text-orange-400 dark:text-orange-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="ms-3">Top charts</span>
                </NavLink>
              </li>
              <li>
                <NavLink
                ...
                >
                  <svg
                    class="w-6 h-6 text-emerald-400 dark:text-emerald-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
              ...
              <li>
                ...
                >
                  <svg
                    class="w-6 h-6 text-pink-400 dark:text-pink-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <span className="ms-3">Radio Station</span>
                </NavLink>
              </li>
            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  <svg
                    class="w-6 h-6 text-purple-400 dark:text-purple-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
